...
<head>
	...
	<link rel="stylesheet" type="text/css" href="styles/directive_library.css">
...
<body ng-controller="NavCtrl as ctrl" layout="column">
	...
	<div style="background:#2795d8;width:100%;height:100%;display:block" id="preload">
		...
		<section id="loadSection">
            <div class="">L</div>
            <div class="delay1">O</div>
            <div class="delay2">A</div>
            <div class="delay3">D</div>
            <div class="delay4">I</div>
            <div class="delay5">N</div>
            <div class="delay6">G</div>
        </section>
	...
	<div layout="column" ng-cloak md-theme="{{$root.theme}}">
		...
		<div class="blut-log-wrapper">
			<div class="left-toggle-wrapper md-primary" md-colors="{background:'primary'}">
				<img ng-src="{{getUserSettings.logo_path}}" err-src="images/digin43x43.png"/>
				...
				<div layout="row" layout-align="end center" class="blut-search-right-wrapper border-left-light">
					...
					<div class="blut-profile-wrapper-header border-left-light">
						<div layout="row" class="blut-login-user pull-right">
							...
							<div class="login-img">
								<img ng-src="{{getUserSettings.dp_path}}" err-src="images/signup-user.png" />
							</div>
		...
		<md-sidenav class="md-sidenav-right md-whiteframe-z2" md-component-id="notifications" style="overflow-y:hidden;z-index:1501;">
			...
			<md-toolbar class="md-primary" style="min-height: 45px;height:45px;">
				<div layout="row" layout-align="space-between center">
					...
					<!--md-button class="md-icon-button" ng-click="openNotifications()" aria-label="close">
		...
		<md-sidenav class="md-sidenav-left md-whiteframe-z2" md-component-id="searchBar" style="overflow-y:hidden;z-index:1501;">
			...
			<md-content style="overflow-y:scroll;height:calc(100% - 45px);padding:0">
				...
				<md-list style="padding:0">
					<md-list-item id="catogory"  ng-repeat="dashboard in dashboards | filter:SearchComponents" ng-click="diginComponents.goDashboard(dashboard)">
		...
		<md-content class="left-menu-slide" ng-mouseenter="sideMenuToggleVisible = true" ng-mouseleave="sideMenuToggleVisible = false" style="height:100%;position:fixed;z-index:3;-webkit-box-shadow:2px 0 3px -2px #888;box-shadow:2px 0 3px -2px #888;top:45px; border-left: 3px solid #8b8b8b;overflow:inherit"  ng-intro-options="IntroOptions" ng-intro-method="Introduce"><!--ng-intro-autostart="firstTime"-->
			<div id="cssmenu">
				<ul>
					<!--li style="margin-top:25px;height:50px;font-size:24px" ng-click="navigate($event,'New Page')"><a><i class="icon-add-page"></i></a></li-->
					...
					<li class="has-sub" style="height:50px;font-size:24px" class="active has-sub"><a class="hover-color" md-colors="{color:'primary'}"><i class="icon-share"></i></a>
						<ul>
					...
					<li class="has-sub" style="height:50px;font-size:24px" class="active has-sub"><a class="hover-color" md-colors="{color:'primary'}"><i class="icon-settings"></i></a>
						<ul>
