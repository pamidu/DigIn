 DiginApp.factory('DiginServices', ['$rootScope','$http', '$v6urls', '$auth', 'notifications', 'Digin_Engine_API', 'Digin_Domain', function($rootScope,$http, $v6urls, $auth,notifications, Digin_Engine_API, Digin_Domain) {
	...
	return {
        getUserSettings: function() {
             ...
             return $http.get('http://prod.digin.io:1929/get_user_settings?SecurityToken=06c9431fe1ccab09bdab32dbb7fb5927&Domain=prod.digin.io')
             ...
             //return the promise directly.
             return $http.get(Digin_Engine_API+'get_all_components?SecurityToken=06c9431fe1ccab09bdab32dbb7fb5927&Domain='+Digin_Domain) //jsons/everything.json
                       .then(function(result) {
                            //resolve the promise as the data
                            return result.data.Result;
                        },function errorCallback(response) {
			 ...
			 notifications.startLoading("Getting Dashboard");
                ...
                return $http.get(Digin_Engine_API+'/get_component_by_comp_id?comp_id='+dashboardId+'&SecurityToken=06c9431fe1ccab09bdab32dbb7fb5927&Domain'+Digin_Domain)
                       .then(function(result) {
                            //resolve the promise as the data
