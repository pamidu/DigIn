DiginApp.controller('chart_designerCtrl',[ '$scope','$rootScope','$mdDialog', '$stateParams','$diginengine','dbType', function ($scope,$rootScope,$mdDialog, $stateParams, $diginengine, dbType){
