DiginApp.controller('clockInit', ['$scope', '$mdDialog', 
    function ($scope, $mdDialog) {
		...
		console.log("before clockmonthDay");
...
DiginApp.controller('clockDialogCtrl', ['$scope', '$mdDialog', function ($scope, $mdDialog) {
