...
*/	  
	...
	directiveLibraryModule.directive('mdBackgroundBanner', function() {
	  return {
		restrict: 'E',
		template: "<div id='prlx_lyr_1' style='position:fixed; background: url() 0px 200px;width:100%;height:800px;'></div> <div id='backgound_banner' style='margin:0px; background:{{color}}; position:fixed; height:{{height}}; width:100%; z-index:0; box-shadow:0 3px 1px -2px rgba(0,0,0,.14),0 2px 2px 0 rgba(0,0,0,.098),0 1px 5px 0 rgba(0,0,0,.084);'></div>",
		scope:{
			color:'@',
			height:'@'
		},
