...
.constant('Digin_Extended_Analytics', 'http://localhost:8080/pentaho/api/repos/xanalyzer/service/selectSchema?ts=1432813521945')
    ...
    .constant('Digin_Engine_API3','http://104.131.48.155:8081/')
    .constant('Digin_Engine_API_Namespace','Demo')
    .constant('Digin_Report_Base', 'http://192.168.0.190:8080/')
    .constant('Digin_PostgreSql', 'http://192.168.0.190:8080/')
