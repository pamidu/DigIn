...
function getHierarchy(parentData) {
    ...
    request += "&tablename=[Demo." + parentData[0] + "]&id=" + id + "&db=BigQuery" ;
...
function getHighest(parentData) {
    ...
    xhr.open("get", url + "gethighestlevel?tablename=[Demo." + parentData[0] + "]&id=1" + "&levels=" + "[" + finalstring + "]" + "&plvl=All&db=BigQuery", /*async*/ true);
