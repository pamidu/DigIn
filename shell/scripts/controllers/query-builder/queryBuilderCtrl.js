...
routerApp.controller('queryBuilderCtrl', function($scope, $rootScope, $location, $window, $csContainer, $diginengine, $state, $stateParams, ngToast, $diginurls, $mdDialog, DB) {
...
routerApp.controller('mainCtrl', function($scope, $rootScope, DB) {
    $scope.mydata = DB.getStatesData();
    $scope.mapconfigured = {};
